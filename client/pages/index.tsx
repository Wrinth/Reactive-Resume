      ...
      <section className={styles.section}>
        ...
        <p className="my-3">
          <Trans t={t} i18nKey="landing.testimonials.contact">
            You can reach out to me through <a href="mailto:johnl4112@gmail.com">my email</a> or through the contact
            form on <a href="https://www.linkedin.com/in/wrinth/">my website</a>.
          </Trans>
        </p>
